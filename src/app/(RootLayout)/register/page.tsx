...
export default function LoginPage() {
  ...
  if (user) return <Redirect path="/account" />;
    ...
    return (
      <Main className="mb-24 mt-12 md:mb-10 2xl:mb-16 md:mt-2 2xl:mt-6 sm:w-[26rem] 2xl:w-[30rem]">
        ...
        {/* <Image
          ...
          quality={50}
          priority={true}
          className="mx-auto h-48 sm:h-24 2xl:h-32 w-auto"
          alt="login image"
          placeholder="empty"
          sizes="(max-width: 768px) 250px, (max-width: 1200px) 350px, 400px"
        /> */}
        <h2 className="mt-12 2xl:mt-24 text-center text-2xl 2xl:text-3xl font-bold tracking-tight text-gray-300">
