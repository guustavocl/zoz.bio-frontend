  ...
  return (
    <React.Fragment>
      <div className="center gap-10 p-10 mb-20 md:px-40 lg:px-96 text-sm">
        <h1 className="pt-1 text-center text-3xl font-bold text-gray-300">
          TERMS OF SERVICE
        </h1>
        <h5 className="pt-1 text-center text-sm font-bold text-gray-300">
        ...
        <p>
          ...
          you, whether personally or on behalf of an entity and us (zoz.gg),
          concerning your access to and use of the https://zoz.gg website as
          ...
          date such revised Terms of Use are posted. The information provided on
        ...
        <p>
          ...
          or regulation. Any use of the Site in violation of the foregoing
        ...
        <p>
          ...
          Policy: <a href="/privacy">https://zoz.gg/privacy</a>. By using the
          ...
          hosted in Brazil. If you access the Site from any other region of the
          ...
          Brazil, then through your continued use of the Site, you are
          transferring your data to Brazil, and you agree to have your data
          transferred to and processed in Brazil.
        </p>
        <br />
        <h4 className="pt-1 font-bold text-lg text-gray-300">
