...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      password: yup.string().required("Password is required").min(6, "Must be at least 6 characters length"),
      cpassword: yup
        .string()
  ...
  return (
    <div className="flex min-h-full items-center justify-center py-1 px-4 sm:px-6 lg:px-8 pb-20 mt-4 md:mt-2">
      <div className="w-full max-w-md">
        <div>
          <img className="mx-auto h-32 sm:h-48 md:h-56" src={registerImg} alt="register image" loading="lazy" />
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div className="py-1">
              <ZozInput
                ...
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                errors={formik.touched.password && formik.errors.password ? formik.errors.password : undefined}
              />
            </div>
            <div className="py-1">
              <ZozInput
                ...
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                errors={formik.touched.cpassword && formik.errors.cpassword ? formik.errors.cpassword : undefined}
              />
            </div>
          </div>
